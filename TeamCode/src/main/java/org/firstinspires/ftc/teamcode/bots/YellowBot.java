...
public class YellowBot implements OdoBot {
    ...
    public static String LEFT_FRONT = "FL";
    public static String RIGHT_FRONT = "FR";
    public static String LEFT_BACK = "BL";
    public static String RIGHT_BACK = "BR";
    ...
    public void init(LinearOpMode owner, HardwareMap hw, Telemetry t) throws Exception {
        ...
        try {
            ...
            horizontalOdo = hwMap.get(DcMotorEx.class, "frontEncoder");
            leftOdo = hwMap.get(DcMotorEx.class, "leftEncoder");
            rightOdo = hwMap.get(DcMotorEx.class, "rightEncoder");
