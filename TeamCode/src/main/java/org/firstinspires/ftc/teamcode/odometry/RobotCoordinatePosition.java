...
public class RobotCoordinatePosition implements Runnable {
    ...
    private static double robotGlobalXCoordinatePosition = 0;
    private static double robotGlobalYCoordinatePosition = 0;
    private static double robotOrientationRadians = 0;
    ...
    public static double getX(){ return robotGlobalXCoordinatePosition; }


    public static double getY(){ return robotGlobalYCoordinatePosition; }
    ...
    public static double getOrientationRad(){ return robotOrientationRadians; }
